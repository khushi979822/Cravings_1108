      ...
      <div className="p-3">
        ...
        <div className="space-y-1 p-4 mt-4">
          {MenuItems.map((item, idx) => (
            <button
              key={idx}
              className={`flex gap-3 font-bold items-center border border-transparent hover:border-(--primary) w-full p-3 rounded-lg ${active === item.name && "bg-orange-600 text-(--primary-text)"}`}
